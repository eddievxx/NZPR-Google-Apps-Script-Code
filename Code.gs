...
function emailRemittanceAdvice() {
  ...
  for (var j = 0; j < numberOfFEDNumbers; j++) { //loop for each unique FED Number to store the caluclated values
    ...
    if (ClientsFee[j] > 0) {//checks whether a fee is present to determine what invoices need to be sent HERE!!!
      ...
      body = "Hi "+ClientsFirstName[j]+", \r\rGood news!\r\rWe've received your petrol refund from the NZTA and will be loading that up for payment into your bank account tonight.\r\rYour refund came to $"+clientRefundInclusive+".\r\rAttached to this email is a payment advice summary and our invoices.\r\rPlease note that our fees have been removed already so there is no need to take any action on these.\r\rMoving forward we will be putting a claim in on your behalf at the end of each financial quarter. We'll contact you to update our details in time for the next claim.\r\rRefer a mate - To help us reach as many people as we can we are offering you a bonus $50 on your next claim for any new client you refer through to us. Your mate gets $50 too. Just reply to this email with a name and number and we'll give them a call.\r\rPlease let me know if you have any questions.\r\rKind regards,\r\rBernard Coogan\r\rDirector\r\rNZ Petrol Refunds Limited\r\rnzpetrolrefunds.co.nz\r\r021 2066 719";
      
          
    } else {
      body = "Hi "+ClientsFirstName[j]+", \r\rWe have received your latest refund from the NZTA and will be loading that up for payment into your account tonight.\r\rYour refund came to $"+clientRefundInclusive+".\r\rPlease see attached payment notice and invoice.\r\rRefer a mate - To help us reach as many people as we can we are offering you a bonus $50 on your next claim for any new client you refer through to us. Your mate gets $50 too. Just reply to this email with a name and number and we'll give them a call.\r\rKind regards,\r\rBernard Coogan\r\rDirector\r\rNZ Petrol Refunds Limited\r\rnzpetrolrefunds.co.nz\r\r021 2066 719"
    }
